...
public enum Op{
	...
	*/
	...
	/** FIXME there should be comment in (getp comment cbtAsUnary structureMadeByCurryInFuncbodyOrConstraintCall)
	cuz now any fn can have a comment in its third of 3 childs (fn.comment())
	so it doesnt go in param list of any op.
	Things are likely to break when change getp from 2 params to 3.
	<br><br>
	(getp cbtAsUnary madeByCurry) returns 1 of the curried params in madeByCurry.
	<br><br>
	OLD...
	<br><br>
	THIS IS INCOMPLETELY DEFINED cuz Op.curry is incompletely defined:
	(getp comment cbtAsUnary structureMadeByCurryInFuncbodyOrConstraintCall).
