...
-- for the parallel redundantly computed operation of potentially dangerous machines (such as graygoo, as its a very tiny piece of universal logic and can redesign its own kinds of addressing) and formal verification, in the same peer to peer networks and turing complete drag-and-drop space as 5 year olds drawing mustaches on cat memes.
