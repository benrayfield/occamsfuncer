...
UPDATE: wikibinator104 will be 7 params, in https://github.com/benrayfield/wikibinator104 which will be axiomforest compatible (only within its own namespace) but has its own axiom system also.
UPDATE: I've found a simpler universal function (6 params instead of 15, with vararg lambdas, and comes with a new kind of set-theory that solves russell's paradox etc) amd am pursuing it in https://github.com/benrayfield/wikibinator101 which will be some of the unlimited number of axioms in https://github.com/benrayfield/axiomforest and that axiom forest could also include occamsfuncer and various other universal functions and systems after I get wikibinator working in it as a proofOfConcept.
